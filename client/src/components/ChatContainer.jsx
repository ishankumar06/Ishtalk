  ...
  return selectedUser ? (
    <div className='h-full overflow-y-scroll relative backdrop-blur-lg'>
      ...
      <div className='flex items-center gap-3 py-3 mx-4 border-b border-stone-500'>
        {/* Back button for mobile and all */}
        <img
          ...
          title="Back"
        />
        <img src={selectedUser.profilePic || assets.avatar_icon} alt="Selected user profile" className="w-8 rounded-full" />
      ...
      <div className='flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6'>
        {messages.map((msg, index) => (
          ...
          >
            {msg.image ? (
              <img src={msg.image} alt="Message attachment" className='max-w-[230px] border border-gray-700 rounded-lg overflow-hidden mb-8' />
            ) : (
            ...
            <div className='text-center text-xs'>
              <img src={msg.senderId === authUser._id ? authUser?.profilePic || assets.avatar_icon : selectedUser?.profilePic ||  assets.avatar_icon} alt="Sender avatar" className='w-7 rounded-full' />
    ...
    <div className='flex flex-col items-center justify-center gap-2 text-gray-500 bg-white/10 max-md:hidden'>
      ...
      <p className='text-lg font-medium text-white'>Ishtay a way to connect</p>
    </div>
  )
}
